...
.method static startMinuteMinderAlarm()V
    ...
    .line 302
    .local v1, MINUTE_MINDER:Ljava/lang/String;
    ...
    .line 305
    .local v7, minuteMinderTone:I
    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "startMinuteMinderAlarm: minuteMinderTone = "
    ...
    sget-object v8, Lcom/android/phone/CallTime;->sAlarmManager:Landroid/app/AlarmManager;

    if-nez v8, :cond_0

    sget-object v8, Lcom/android/phone/CallTime;->sPendingIntent:Landroid/app/PendingIntent;
    ...
    .line 311
    const-string v8, "startMinuteMinderAlarm:.."
    ...
    .line 314
    .local v4, firstAlertTime:J
    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "startMinuteMinderAlarm:.. first "
    ...
    .line 329
    .end local v4           #firstAlertTime:J
    :cond_0
    :goto_0
    return-void

    .line 319
    .restart local v4       #firstAlertTime:J
    :cond_1
    invoke-static {}, Lcom/android/phone/PhoneGlobals;->getInstance()Lcom/android/phone/PhoneGlobals;
    ...
    sput-object v8, Lcom/android/phone/CallTime;->sAlarmManager:Landroid/app/AlarmManager;

    .line 322
    new-instance v6, Landroid/content/Intent;

    const-string v8, "com.android.phone.MINUTE_MINDER_ALARM"
    ...
    invoke-static {v2, v11, v6, v8}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v8

    sput-object v8, Lcom/android/phone/CallTime;->sPendingIntent:Landroid/app/PendingIntent;
    ...
    sget-object v12, Lcom/android/phone/CallTime;->sPendingIntent:Landroid/app/PendingIntent;
